    ...
    return _then(_value.copyWith(
      ...
      additionalInfo: null == additionalInfo
          ...
          : additionalInfo // ignore: cast_nullable_to_non_nullable
              as Map<String, bool>,
      howToPlay: null == howToPlay
          ? _value.howToPlay
          : howToPlay // ignore: cast_nullable_to_non_nullable
              as List<String>,
...
class _$CharacterImpl implements _Character {
  ...
  final Map<String, bool> _additionalInfo;
  @override
  Map<String, bool> get additionalInfo {
  ...
  final List<String> _howToPlay;
  @override
  List<String> get howToPlay {
    if (_howToPlay is EqualUnmodifiableListView) return _howToPlay;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_howToPlay);
  }
...
abstract class _Character implements Character {
  const factory _Character(
      ...
      required final Fraction fraction,
      required final Map<String, bool> additionalInfo,
      required final List<String> howToPlay,
      required final List<String> otherNames,
